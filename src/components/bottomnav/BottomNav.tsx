...
const BottomNav = () => {
  ...
  return (
    <section className="bg-[#ffffff] sm:hidden px-3 py-2 fixed  bottom-0 w-full shadow-xl flex items-center gap-3 justify-between overflow-x-scroll rounded-tr-3xl rounded-tl-3xl border border-[#aad0d0]">
        ...
        return (
          <Link 
            ...
            className={`${activeItem && "text-white rounded-2xl bg-[#1D8EE6] w-max whitespace-nowrap"
              } flex justify-evenly flex-1 gap-x-1 items-center rounded-full px-3 py-2 cursor-pointer my-0  text-base space-x-1`}
          >
