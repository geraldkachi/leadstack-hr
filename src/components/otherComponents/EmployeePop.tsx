  ...
  return (
    <>
      <ClickOutside onclickoutside={() => setState(false)} className={` text-black`} >
        {state && <>
          <div className="flex flex-col items-start justify-start list-none top-10 md:top-36 opacity-100 absolute r-2 right-5 md:right-32 bg-white dark:bg-gradient-to-t transition-all dark:from-[#ffffff] dark:vai-[#292929] shadow-3xl rounded-md w-[150px] z-20">
