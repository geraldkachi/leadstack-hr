...
import type { TableRowSelection } from 'antd/es/table/interface';import { Button, Input } from "../../components";
        ...
        <div>
            ...
            <div className="bg-[#F5F6FA] px-4 md:px-8">
                <div className="grid grid-cols-2 lg:grid-cols-6 gap-4 py-3 h-max">
                    ...
                    <a className="col-span-1 flex flex-col items-start bg-white rounded-md shadow md:flex- md:max-w-xl hover:bg-slate-50 p-4 md:p-5">
                        <div className="text-lg md:text-4xl text-[rgb(13,18,39)]">150</div>
                        <div className="flex items-center my-3">
                            <div className="h-4 w-4 rounded-full bg-[#1EAA79]"></div>
                            <span className="text-sm text-[#7C8091] ml-2">Hired</span>
                        </div>
                    </a>
                    <a className="col-span-1 flex flex-col items-start bg-white rounded-md shadow md:flex- md:max-w-xl hover:bg-slate-50 p-4 md:p-5">
                        <div className="text-lg md:text-4xl text-[rgb(13,18,39)]">65</div>
                        <div className="flex items-center my-3">
                            <div className="h-4 w-4 rounded-full bg-[#FFB240]"></div>
                            <span className="text-sm text-[#7C8091] ml-2">On-Hold</span>
                        </div>
                    </a>
                    <a className="col-span-1 flex flex-col items-start bg-white rounded-md shadow md:flex- md:max-w-xl hover:bg-slate-50 p-4 md:p-5">
                        <div className="text-lg md:text-4xl text-[rgb(13,18,39)]">50</div>
                        <div className="flex items-center my-3">
                            <div className="h-4 w-4 rounded-full bg-[#1D8EE6]"></div>
                            <span className="text-sm text-[#7C8091] ml-2">Test</span>
                        </div>
                    </a>
                    <a className="col-span-1 flex flex-col items-start bg-white rounded-md shadow md:flex- md:max-w-xl hover:bg-slate-50 p-4 md:p-5">
