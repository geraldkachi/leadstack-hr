      ...
      <div className="grid grid-cols-4 gap-4 py-3">
        ...
        <a className="flex flex-col items-center bg-white rounded-md shadow md:flex-row md:max-w-xl hover:bg-slate-50 ">
          <div className="flex flex-col justify-between p-4 leading-norma pr-20">
            ...
            <p className="mb-3 font-normal text-[#7C8091] text-sm wh">Current Job Openings</p>
          </div>

          <div className="w-full h-full bg-[#E8F4FC]">
            <img className=" w-full h-max bg-[#E8F4FC] p-3" src="/card-file.svg" alt="" />
          </div>
        </a>
        ...
        <a className="flex flex-col items-center bg-white rounded-md shadow md:flex-row md:max-w-xl hover:bg-slate-50 ">
          ...
          <div className="w-full h-full bg-[#fff7ec]">
            <img className=" w-full h-max bg-[#fff7ec] p-3" src="/card-clock.svg" alt="" />
          </div>
        </a>
        ...
        <a className="flex flex-col items-center bg-white rounded-md shadow md:flex-row md:max-w-xl hover:bg-slate-50 ">
          ...
          <div className="w-full h-full bg-[#F3FCF9]">
            <img className=" w-full h-max bg-[#F3FCF9] p-3" src="/card-done.svg" alt="" />
          </div>
        </a>
        ...
        <a className="flex flex-col items-center bg-white rounded-md shadow md:flex-row md:max-w-xl hover:bg-slate-50 ">
          ...
          <div className="w-full h-full bg-[#FFEFED]">
            <img className=" w-full h-max bg-[#FFEFED] p-3" src="/card-flag.svg" alt="" />
          </div>
        </a>

      </div>
      <div className="flex items-center justify-between py-3">
        <span className="tex">Leave History</span>
